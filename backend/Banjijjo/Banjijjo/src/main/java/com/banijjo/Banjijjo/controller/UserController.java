...
import com.banijjo.Banjijjo.exception.UserNotFoundException;
...
@CrossOrigin("http://localhost:3000/") // connecting the API layer with frontend's URL. Allow frontend port (3000) with backend port (8080)
